...
const Contact = () => {
  return (
    <section className="min-h-screen bg-gradient-to-b from-white to-[#F3F4F6] py-20 px-6 md:px-16">
      <div className="max-w-6xl mx-auto text-center space-y-6">
        {/* <h2 className="text-sm font-semibold tracking-widest text-green-500 uppercase">
          Contact Us
        </h2> */}
      ...
      <div className="grid md:grid-cols-2 gap-14 items-center mt-16">
        ...
        <div className="flex justify-center">
          <img
            src={Logo}
            alt="Upthrust Esports"
            className="w-72 md:w-96 object-contain"
          />
        </div>

        {/* Contact Card */}
        <div className="bg-white/60 border border-gray-200 backdrop-blur-xl rounded-3xl shadow-xl p-8 md:p-12 space-y-8 transition-all hover:shadow-2xl">
          <p className="text-gray-700 text-md md:text-lg">
            Welcome to the next level of gaming innovation! At{" "}
            <span className="font-semibold text-green-600">Titans Gaming</span>,
            ...
            <ContactInfo
              ...
              value={
                <>
                  ...
                  Email:{" "}
                  <a
                    href="mailto:contact@upthrustesports.com"
